...
class Hasher implements IHasher {
	...
	public function __construct(IConfig $config) {
		...
		if (\defined('PASSWORD_ARGON2I')) {
			...
			// In this case, set default, or minimum if PASSWORD_ARGON2_DEFAULT_* variable is invalid as well.
			$this->options['threads'] = max($this->config->getSystemValueInt('hashingThreads', PASSWORD_ARGON2_DEFAULT_THREADS), PASSWORD_ARGON2_DEFAULT_THREADS, 1);
			// The minimum memory cost is 8 KiB per thread.
			$this->options['memory_cost'] = max($this->config->getSystemValueInt('hashingMemoryCost', PASSWORD_ARGON2_DEFAULT_MEMORY_COST), PASSWORD_ARGON2_DEFAULT_MEMORY_COST, $this->options['threads'] * 8);
			$this->options['time_cost'] = max($this->config->getSystemValueInt('hashingTimeCost', PASSWORD_ARGON2_DEFAULT_TIME_COST), PASSWORD_ARGON2_DEFAULT_TIME_COST, 1);
		}
